...
# A Few Things to Try
# "99 bottles of beer on the wall..." Write a program which
# prints out the lyrics to that beloved classic, that 
# field-trip favorite: "99 Bottles of Beer on the Wall."

# beer = 99

# while beer > 0
#   puts "#{beer} bottles of beer on the wall, #{beer} bottles of beer, take\
#  one down, pass it around, #{beer - 1} bottles of beer on \
# the wall"
#   beer -= 1
# end

# puts "Hello, my name is Granny"
# answer = gets.chomp
# while answer != 'BYE'
...
#   answer = gets.chomp
# end
# puts 'Bye sonny, it was great talking with you!'



# Granny says Hi
# if you say 'BYE' three times in a row, you are free.
# unless you say something in all caps, granny tells you to speak up
# while you say something in all caps, unless it is 'BYE' granny will keep saying 'Not since 1938!'
...
#   puts "NO, NOT SINCE #{rand(1930..1950)}"
# end
# puts "Bye sonny, it was nice talking with you!"
...
# anything. Seriously! Just look at all the things you 
