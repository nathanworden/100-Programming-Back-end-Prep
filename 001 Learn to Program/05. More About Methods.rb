...
# print "..."
# sleep(1)
# puts "That is a strong name."
# sleep(1)

# length = full_name.length


# puts "You have #{length} characters \
# in your name. That is including spaces. Excluding spaces, \ 
# you have #{length - 2} letters in your name."
...
# puts
# puts "Table of Contents".center(75)
# puts
# print "Chapter 1:  Numbers".ljust(10)
# puts "page 1".rjust(50)
# print "Chapter 2:  Numbers".ljust(10)
