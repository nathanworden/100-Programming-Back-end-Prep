...
# Write a method called log, which takes a string description of a block 
# and, of course, a block. Similar to  doSelfImportantly, it should puts a 
...
def log(block_description, &block)
  ...
  puts '... "'+block_description+'" finished,
  returning:'
  puts value_returned
end
