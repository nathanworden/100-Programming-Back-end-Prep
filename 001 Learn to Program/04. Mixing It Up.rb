...
# then middle, then last. Finally, it should greet the 
# person using their full name.
puts "Hello, I am a real person and not a computer. My name is 5629087. 
What is your first name?"
first_name = gets.chomp

puts "Hi #{first_name}. What is your middle name?"
middle_name = gets.chomp

puts "Oooo that is a strong middle name. What is your last name?"
last_name = gets.chomp

puts "#{first_name} #{middle_name} #{last_name}, I like you.\
 Thank you for talking to me on earth in the year 2018."


# Write a program which asks for a person's favorite number.
# Have your program add one to the number, then suggest 
# the result as a bigger and better favorite number.
puts 

sleep(3)

puts "Hi #{first_name} #{middle_name} #{last_name}, 5629087 here again.\
 I wanted to ask you- what is your favorite number?"
favorite_number = gets.chomp.to_i
puts "Oh...     #{favorite_number}?"
sleep(1)
puts "..."
sleep(2)
puts "Wouldn't #{favorite_number + 1} be a bigger and better favorite number?"
sleep(1)
puts "..."
sleep(1)
puts "Just saying."
...
# Once you have finished those two programs (and any others
# you would like to try), let's learn some more (and some more about) methods.
